      ...
      <div className="flex flex-col gap-2">
        <div className="w-full bg-gradient-to-r from-[#304352] to-[#cbd5e1] rounded-md px-10 py-5">
          ...
          <Typography className="text-sm font-bold text-white">
            ...
            trên sở thích và kỹ năng cá nhân của ứng viên, mang lại trải nghiệm
            gợi ý cá nhân và đa dạng trong sự nghiệp của họ.
          </Typography>
        </div>
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            <div
              className={`${
                isColumnCard ? "grid grid-cols-3" : "flex flex-col"
              } gap-2`}
            >
